package com.cn.permission.job.service.impl;

import com.cn.permission.common.annotation.CronTag;
import com.cn.permission.common.service.impl.BaseService;
import com.cn.permission.job.dao.JobMapper;
import com.cn.permission.job.domain.Job;
import com.cn.permission.job.service.JobService;
import com.cn.permission.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.cn.permission.job.task");

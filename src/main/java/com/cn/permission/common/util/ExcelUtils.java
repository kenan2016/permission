package com.cn.permission.common.util;

import com.cn.permission.common.annotation.ExportConfig;
import com.cn.permission.common.handler.ExportHandler;
import com.cn.permission.common.util.poi.convert.ExportConvert;
import com.cn.permission.common.util.poi.pojo.ExportItem;
import com.cn.permission.common.util.poi.convert.ExportConvert;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.cn.permission.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.cn.permission.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
